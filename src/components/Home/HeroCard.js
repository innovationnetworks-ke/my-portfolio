...
function copyToClipboard(str) {
  ...
  // cost [text,SelectedText]="Age";
  // const date = useState(`new Date().getFullYear() - 2014;`);
  ...
  return (
    <CodeCardWrapper>
      ...
      <pre>
        4&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.traits = ["<b>FULL_STACK DEVELOPER IN</b>", "<b>Python, PHP, React, Angular</b>"];
      </pre>
      {/* <pre onClick={changeText}>5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.experience = {text}</pre>
      <pre onClick={changeText}>5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.experience = {text}</pre> */}
      <pre>6&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {'}'}</pre>
      <pre>7&nbsp;&nbsp;{'}'}</pre>
    </CodeCardWrapper>
